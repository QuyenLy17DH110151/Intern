...
export class UserClient {
    ...
    createUser(user: CreateUserRequest) : Observable<string>{
        var token = 'eyJhbGciOiJodHRwOi8vd3d3LnczLm9yZy8yMDAxLzA0L3htbGRzaWctbW9yZSNobWFjLXNoYTI1NiIsInR5cCI6IkpXVCJ9..7XZ5q3AaqvLpprucALFR2s6m71Az4lzjseehoBZ5t5A';
        var httpOptions = {
